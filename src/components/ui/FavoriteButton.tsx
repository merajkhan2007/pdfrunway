...
export function FavoriteButton({
    ...
    if (!isLoaded) {
        return (
            ...
            >
                <div
                    className={`${sizeConfig.button} rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center`}
                >
                    <Star className={`${sizeConfig.icon} text-gray-300 dark:text-gray-500`} />
                </div>
                {showLabel && (
      ...
      `}
        ...
        `}
            ...
            ${favorite
                            ...
                            : 'text-gray-400 hover:text-amber-400 dark:text-gray-400'
                        }
          `}
                />
            </div>
